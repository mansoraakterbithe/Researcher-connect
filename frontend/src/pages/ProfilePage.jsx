...
const STUDENT_PROFILE = {
  ...
  dnaBars: [
    {
      label: "AI/ML",
      pct: 90,
      color: "linear-gradient(to top,#1B3A6B,#5BA4E6)",
    },
    {
      label: "Vision",
      pct: 75,
      color: "linear-gradient(to top,#4A2C6B,#a78bfa)",
    },
    {
      label: "Medicine",
      pct: 60,
      color: "linear-gradient(to top,#1B6B3A,#34d399)",
    },
    {
      label: "Data Sci",
      pct: 45,
      color: "linear-gradient(to top,#8B6914,#FFD700)",
    },
    { label: "NLP", pct: 30, color: "linear-gradient(to top,#2C5AA0,#7CC4F0)" },
    {
      label: "Stats",
      pct: 20,
      color: "linear-gradient(to top,#6B1B3A,#f87171)",
    },
  ],
  impactBreakdown: [
    {
      ...
      val: 280,
      pct: 40,
      color: "linear-gradient(90deg,#FFD700,#FFB800)",
    },
    {
      label: "Matches",
      val: 180,
      pct: 65,
      color: "linear-gradient(90deg,#5BA4E6,#2C5AA0)",
    },
    {
      label: "Activity",
      val: 200,
      pct: 55,
      color: "linear-gradient(90deg,#34d399,#2CA05A)",
    },
    {
      label: "Connections",
      val: 122,
      pct: 30,
      color: "linear-gradient(90deg,#a78bfa,#7B3FA0)",
    },
  ],
  timeline: [
    {
      ...
      popup: {
        ...
        stats: [
          { val: "94.3%", label: "Accuracy" },
          { val: "0.91", label: "F1 Score" },
          { val: "IEEE", label: "Venue" },
        ],
      },
    },
    {
      ...
      popup: {
        ...
        stats: [
          { val: "0.744", label: "Mean IoU" },
          { val: "0.570", label: "Baseline" },
          { val: "+30%", label: "Improvement" },
        ],
      },
    },
    {
      ...
      popup: {
        ...
        stats: [
          { val: "100%", label: "Event Detection" },
          { val: "LightGBM", label: "Model" },
          { val: "SHAP", label: "XAI" },
        ],
      },
    },
  ...
  readingList: [
    {
      title: "SAM: Segment Anything — Kirillov et al.",
      venue: "ICCV 2023",
      date: "Jul 2024",
    },
    {
...
const SUPERVISOR_PROFILE = {
  ...
  status: "active",
  about:
    "Professor of Medical AI at UCL. My research focuses on Vision Transformers and explainable deep learning for clinical decision support. 24 peer-reviewed publications including MICCAI, NeurIPS and Nature Medicine. Currently leading a £2.1M UKRI-funded project on AI-assisted radiology.",
  researchAreas: [
    "Medical Imaging",
    "Vision Transformers",
    "Explainable AI",
  ...
  availability: {
    ...
    fundedSlots: 2,
    scholarshipSupport:
      "Full UKRI scholarship available for exceptional candidates. Covers tuition + £18,000/year stipend.",
    projectType: "Both my projects and student-proposed topics",
    levels: ["Masters", "PhD"],
    responseTime: "3-5 working days",
    requirements:
      "Strong Python and ML background, ideally some experience with medical imaging or computer vision. UK/EU students preferred but international considered.",
  ...
  recentPapers: [
    {
      ...
      popup: {
        ...
        stats: [
          { val: "MICCAI", label: "Venue" },
          { val: "91.2%", label: "Dice Score" },
          { val: "2026", label: "Year" },
        ],
      },
    },
    {
      title:
        "Explainable AI for Clinical Decision Support — SHAP meets Attention",
      ...
      popup: {
        ...
        stats: [
          { val: "Nature Medicine", label: "Venue" },
          { val: "92.1%", label: "AUC" },
          { val: "3 hospitals", label: "Trial" },
        ],
      },
    },
  ],
  supervisedStudents: [
    {
      ...
      degree: "PhD",
      year: "2024",
      topic: "Transformer-based ECG analysis",
    },
    {
      name: "Priya Sharma",
      degree: "Masters",
      year: "2025",
      topic: "Federated learning for radiology",
    },
  ],
  endorsementList: [
...
function ProfilePage() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        // If there is an ID in the URL, fetch that user's profile
  ...
  const PROFILE = profileData
    ? {
        ...
        fundingNeeded:
          profileData.fundingNeeded || STUDENT_PROFILE.fundingNeeded,
  ...
  async function handleApplySubmit(e) {
    ...
    try {
      const res = await authFetch("/applications", {
        method: "POST",
        body: JSON.stringify({
          supervisorId: profileData?._id,
          why: applyForm.why,
          background: applyForm.background,
          topic: applyForm.topic,
          funding: applyForm.funding,
        }),
      });
      ...
      setApplyError("Cannot connect to server. Please try again.");
    } finally {
      ...
      <div className="pp-header-wrap">
        <div className="pp-header-inner">
          <div className="pp-avatar-row">
            ...
            <div className="pp-header-actions">
              ...
              <div className="pp-action-row">
                ...
                {isSupervisor && (
                  <button
                    className="pp-btn-primary pp-btn-apply"
                    onClick={() => setShowApplyModal(true)}
                  >
                    🎓 Apply to Work With
                  </button>
          ...
          <div className="pp-name-section">
            ...
            <div className="pp-uni">
              {PROFILE.department} · {PROFILE.university}, UK
            </div>
            <div className="pp-location">
              📍 {PROFILE.location} ·{" "}
              {PROFILE.remote ? "Open to Remote" : "On-site only"}
            </div>
          </div>
          ...
          <div className="pp-open-row">
            ...
            {PROFILE.openTo.map((item) => (
              <span
                key={item.label}
                className={`pp-open-chip ${item.on ? "on" : "off"}`}
              >
                {item.label}
              </span>
            ))}
          ...
          {isStudent && PROFILE.seekingSupervisor && (
            <div className="pp-seeking-banner">
              ...
              <div>
                <div className="pp-seeking-title">
                  🎓 Actively Seeking PhD Supervisor
                </div>
                <div className="pp-seeking-sub">
                  Target: {PROFILE.targetDegree} · Start:{" "}
                  {PROFILE.availableFrom} · Funding: {PROFILE.fundingNeeded}
                </div>
              </div>
              <button
                className="pp-seeking-btn"
          ...
          {isSupervisor && (
            <div className="pp-avail-banner">
              <div
                className={`pp-avail-banner-dot ${PROFILE.availability.status}`}
              />
              <div>
                <div className="pp-avail-banner-title">
                  {PROFILE.availability.status === "open" &&
                    "🟢 Currently accepting research students"}
                ...
                <div className="pp-avail-banner-sub">
                  {PROFILE.availability.fundedPhD &&
                    `${PROFILE.availability.fundedSlots} funded PhD positions available · `}
          ...
          <div className="pp-stats-row">
            {(isStudent
              ? [
                  {
                    num: PROFILE.papersCount.toString(),
                    label: "Papers",
                    color: "",
                  },
                  {
                    num: `${PROFILE.matchScore}%`,
                    label: "Match Score",
                    color: "gold",
                  },
                  {
                    num: PROFILE.followers.toString(),
                    label: "Followers",
                    color: "",
                  },
                  {
                    num: PROFILE.following.toString(),
                    label: "Following",
                    color: "",
                  },
                  {
                    num: PROFILE.impactScore.toString(),
                    label: "Impact Score",
                    color: "green",
                  },
                  {
                    num: PROFILE.endorsementsCount.toString(),
                    label: "Endorsements",
                    color: "",
                  },
                ]
              : [
                  ...
                  {
                    num: PROFILE.availability.fundedSlots.toString(),
                    label: "Funded Slots",
                    color: "green",
                  },
                  {
                    num: PROFILE.supervisedStudents.length.toString(),
          ...
          <div className="pp-reactions">
            <button
              className={`pp-react-btn like ${liked ? "active" : ""}`}
              onClick={handleLike}
            >
              <svg
                viewBox="0 0 24 24"
            ...
            <button
              className={`pp-react-btn interest ${interested ? "active" : ""}`}
            ...
            <>
              <div className="pp-card">
                <div className="pp-card-head">
                  About <span className="pp-card-edit">✏️ Edit</span>
                </div>
                ...
                <div className="pp-card">
                  ...
                  <div className="pp-skills-wrap">
                    {PROFILE.researchAreas.map((area) => (
                      <span key={area} className="pp-skill">
                        {area}
                      </span>
                    ))}
                  </div>
              ...
              <div className="pp-card">
                ...
                <div className="pp-impact-wrap">
                  <div className="pp-impact-ring">
                    ...
                    <div className="pp-impact-center">
                      {PROFILE.impactScore}
                    </div>
                  </div>
              ...
              {isStudent && (
                <div className="pp-card">
                  <div className="pp-card-head">
                    Skills & Tools <span className="pp-card-edit">✏️ Edit</span>
                  </div>
                  <div className="pp-skills-wrap">
                    {PROFILE.skills.map((skill) => (
                      <span
                        key={skill.name}
                        className={`pp-skill ${skill.endorsed ? "endorsed" : ""}`}
                      >
                        {skill.name}
                        {skill.endorsed ? " ✓" : ""}
                      </span>
              ...
              {isStudent && (
                <div className="pp-card">
                  <div className="pp-card-head">
                    Research Journey{" "}
                    <span className="pp-card-edit">✏️ Edit</span>
                  </div>
                ...
                <div className="pp-card">
                  ...
                  {PROFILE.supervisedStudents.map((s, i) => (
                    <div key={i} className="pp-supervised-item">
                      <div className="pp-supervised-avatar">
                        {s.name
                          .split(" ")
                          .map((n) => n[0])
                          .join("")}
                      ...
                      <div>
                        ...
                        <div className="pp-supervised-meta">
                          {s.degree} · {s.year} · {s.topic}
                        </div>
                      </div>
                    </div>
                  ))}
                  ...
                  <div className="pp-reading-list">
                    {PROFILE.readingList.map((paper, i) => (
                      <div key={i} className="pp-reading-item">
                        ...
                        <div className="pp-reading-meta">
                          {paper.venue} · Read {paper.date}
                        </div>
                      </div>
                    ))}
                  </div>
        ...
        <aside className="pp-right">
          {isSupervisor && (
            <div className="pp-avail-card">
              <div className="pp-avail-head">
                <div
                  className={`pp-avail-status ${PROFILE.availability.status}`}
                >
              ...
              <div className="pp-avail-grid">
                ...
                <div className="pp-avail-item">
                  ...
                  <div className="pp-avail-val gold">
                    {PROFILE.availability.fundedSlots} positions
                  </div>
                </div>
                <div className="pp-avail-item">
                  <div className="pp-avail-label">Levels</div>
                  <div className="pp-avail-val">
                    {PROFILE.availability.levels.join(", ")}
                  </div>
                </div>
                <div className="pp-avail-item">
              ...
              <div className="pp-avail-scholarship">
                ...
                <div className="pp-avail-scholarship-text">
                  {PROFILE.availability.scholarshipSupport}
                </div>
              </div>
              <div className="pp-avail-req">
                <div className="pp-avail-label">Requirements</div>
                <div className="pp-avail-req-text">
                  {PROFILE.availability.requirements}
                </div>
              </div>
              <div className="pp-avail-deadline">
                📅 {PROFILE.availability.deadline}
              </div>
              <div className="pp-avail-deadline">
                🗓 Start: {PROFILE.availability.startDate}
              </div>
              <button
          ...
          {isStudent && (
            <div className="pp-collab-card">
              ...
              <div className="pp-collab-sub">
                Tell {PROFILE.name.split(" ")[0]} what you'd like to work on
              </div>
              <textarea
                ...
                <form className="pp-modal-form" onSubmit={handleApplySubmit}>
                  <div className="pp-modal-field">
                    ...
                    <textarea
                      ...
                      value={applyForm.why}
                      onChange={(e) =>
                        setApplyForm({ ...applyForm, why: e.target.value })
                      }
                      required
                      rows={3}
                    />
                    ...
                    {[
                      {
                        icon: "📄",
                        title: "CV / Resume",
                        sub: "Your academic or research CV",
                        key: "cv",
                        accept: ".pdf,.doc,.docx",
                      },
                      {
                        ...
                        sub: "Why you want to do this research",
                        key: "statement",
                        accept: ".pdf,.doc,.docx",
                      },
                      {
                        ...
                        sub: "Your grades and academic record",
                        key: "transcript",
                        accept: ".pdf,.doc,.docx,.jpg,.png",
                      },
                      {
                        icon: "📝",
                        title: "Writing Sample / Past Paper",
                        sub: "A paper or project you have written",
                        key: "writing",
                        accept: ".pdf,.doc,.docx",
                      },
                      {
                        ...
                        sub: "From a previous supervisor or lecturer",
                        key: "reference",
                        accept: ".pdf,.doc,.docx",
                      },
                      {
                        ...
                        sub: "Portfolio, certificate, or anything else",
                        key: "other",
                      ...
                      <div key={doc.key} className="pp-modal-doc-row">
                        ...
                        {applyForm[doc.key] && (
                          <div className="pp-modal-doc-done">✓</div>
                        )}
                      </div>
                    ))}

                    <div className="pp-modal-doc-note">
                      📌 All documents go directly to their ResearchConnect
                      inbox — no email needed. Max 5MB per file. PDF preferred.
                    </div>
                  </div>

    ...
    <>
      <nav className="shared-nav">
        ...
        <div className="shared-nav-right">
          <div
            className={`shared-nav-link ${activePage === 'home' ? 'active' : ''}`}
            onClick={() => navigate('/home')}
          >
            Home
          </div>
          <div
            className={`shared-nav-link ${activePage === 'connections' ? 'active' : ''}`}
            onClick={() => navigate('/connections')}
          >
            Connections
          </div>
          <div
            className={`shared-nav-link ${activePage === 'messages' ? 'active' : ''}`}
            onClick={() => navigate('/messages')}
          >
            Messages
          </div>
          <div
            className={`shared-nav-link ${activePage === 'notifications' ? 'active' : ''}`}
            onClick={() => navigate('/notifications')}
          >
            🔔 Notifications
          </div>

          <button className="shared-new-btn" onClick={() => setShowPostModal(true)}>
            + New Post
          </button>

          <div className="shared-avatar-wrap" ref={menuRef}>
            <div
            ...
            {showAvatarMenu && (
              <div className="shared-avatar-menu">
                <div className="shared-menu-item" onClick={() => { navigate('/profile'); setShowAvatarMenu(false); }}>
                  👤 View Profile
                </div>
                <div className="shared-menu-item" onClick={() => { navigate('/profile/edit'); setShowAvatarMenu(false); }}>
                  ✏️ Edit Profile
                </div>
                <div className="shared-menu-item" onClick={() => { navigate('/notifications'); setShowAvatarMenu(false); }}>
                  🔔 Notifications
                </div>
                <div className="shared-menu-item" onClick={() => { navigate('/messages'); setShowAvatarMenu(false); }}>
                  💬 Messages
                </div>
                <div className="shared-menu-item" onClick={() => { navigate('/settings'); setShowAvatarMenu(false); }}>
                  ⚙️ Settings
                </div>
                <div className="shared-menu-divider"/>
                <div className="shared-menu-item logout" onClick={handleLogout}>
                  🚪 Logout
                </div>
              </div>
            )}
